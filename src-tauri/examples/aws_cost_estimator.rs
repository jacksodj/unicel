...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    sheet1.set(
        CellAddr::new("A", 1),
        Cell::with_text("AWS Cost Estimate - US East (Virginia)"),
    )?;
    ...
    sheet1.set(
        CellAddr::new("D", 5),
        Cell::new(730.0, Unit::simple("hr", BaseDimension::Time)),
    )?;
    ...
    sheet1.set(
        CellAddr::new("B", 12),
        Cell::new(1.0, Unit::dimensionless()),
    )?;
    sheet1.set(
        CellAddr::new("C", 12),
        Cell::new(
    ...
    sheet1.set(
        CellAddr::new("A", 18),
        Cell::with_text("Outbound to Internet"),
    )?;
    sheet1.set(
        CellAddr::new("B", 18),
        Cell::new(5000.0, Unit::simple("GB", BaseDimension::DigitalStorage)),
    )?;
    sheet1.set(
        CellAddr::new("C", 18),
        Cell::new(
    ...
    sheet1.set(
        CellAddr::new("A", 19),
        Cell::with_text("Inter-region Transfer"),
    )?;
    sheet1.set(
        CellAddr::new("B", 19),
        Cell::new(2000.0, Unit::simple("GB", BaseDimension::DigitalStorage)),
    )?;
    sheet1.set(
        CellAddr::new("C", 19),
        Cell::new(
    ...
    sheet1.set(
        CellAddr::new("A", 20),
        Cell::with_text("Data Transfer Subtotal"),
    )?;
    ...
    sheet1.set(
        CellAddr::new("A", 24),
        Cell::new(10000.0, Unit::simple("GB", BaseDimension::DigitalStorage)),
    )?;
    sheet1.set(
        CellAddr::new("B", 24),
        Cell::new(
    ...
    sheet1.set(
        CellAddr::new("A", 26),
        Cell::with_text("MONTHLY TOTAL (US East)"),
    )?;
    sheet1.set(
        CellAddr::new("E", 26),
        Cell::with_formula("=E8 + E14 + D20 + C24"),
    )?;
    ...
    sheet2.set(
        CellAddr::new("A", 1),
        Cell::with_text("AWS Cost Estimate - EU West (Ireland)"),
    )?;
    ...
    sheet2.set(
        CellAddr::new("B", 10),
        Cell::new(3000.0, Unit::simple("GB", BaseDimension::DigitalStorage)),
    )?;
    sheet2.set(
        CellAddr::new("C", 10),
        Cell::new(
    ...
    sheet2.set(
        CellAddr::new("A", 12),
        Cell::with_text("MONTHLY TOTAL (EU West)"),
    )?;
    ...
    sheet3.set(
        CellAddr::new("A", 1),
        Cell::with_text("Scaling Scenario - 2x Traffic Growth"),
    )?;

    sheet3.set(
        CellAddr::new("A", 3),
        Cell::with_text("Current Monthly Cost"),
    )?;
    sheet3.set(
        CellAddr::new("B", 3),
        Cell::new(2000.0, Unit::simple("USD", BaseDimension::Currency)),
    )?;
    ...
    sheet3.set(
        CellAddr::new("A", 5),
        Cell::with_text("Projected Monthly Cost"),
    )?;
    ...
    sheet3.set(
        CellAddr::new("A", 9),
        Cell::with_text("NOTE: This demonstrates:"),
    )?;
    sheet3.set(
        CellAddr::new("A", 10),
        Cell::with_text("- Compound units (USD/hr × hr = USD)"),
    )?;
    sheet3.set(
        CellAddr::new("A", 11),
        Cell::with_text("- Data transfer costs (GB × USD/GB = USD)"),
    )?;
    sheet3.set(
        CellAddr::new("A", 12),
        Cell::with_text("- Multi-currency scenarios (USD vs EUR)"),
    )?;
    sheet3.set(
        CellAddr::new("A", 13),
        Cell::with_text("- Scaling projections with dimensionless multipliers"),
    )?;
